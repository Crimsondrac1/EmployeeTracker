...
const { addDept, delDept } = require("./utils/action");
        ...
        inquirer
          ...
          .then((roleChoice) => {
            ...
            db.query(managerSql, (err, data) => {
              ...
              const managers = data.map(({ id, fName, lName }) => ({
                name: fName + " " + lName,
                value: id,
              }));
              ...
              inquirer
                ...
                .then((managerChoice) => {
                  ...
                  db.query(sql, params, (err, result) => {
                    ...
                    console.log(
                      c.green(
                        answer.fName + " " + answer.lName + " has been added!"
                      )
                    );
...
delEmp = () => {
  ...
  db.query(employeeSql, (err, data) => {
    ...
    const employees = data.map(({ id, fName, lName }) => ({
      value: id,
      name: fName + " " + lName,
    }));
    ...
    inquirer
      ...
      .then((empChoice) => {
        ...
        const { fName, lName } = data.find((emp) => emp.id === empChoice.name);
        ...
        db.query(sql, employee, (err, result) => {
          if (err) throw err;
          console.log(
            c.green("Successfully deleted employee " + fName + " " + lName)
          );
...
updEmp = () => {
  console.log(
    c.yellow(".  ..__ .__ .__..___..___  .___.  ..__ .   .__..   ,.___.___")
  );
  console.log(
    c.yellow("|  |[__)|  \\[__]  |  [__   [__ |\\/|[__)|   |  | \\./ [__ [__")
  );
  console.log(
    c.yellow("|__||   |__/|  |  |  [___  [___|  ||   |___|__|  |  [___[___")
  );
  console.log(
    c.yellow("____________________________________________________________")
  );
...
updManager = () => {
  console.log(
    c.yellow(".  ..__ .__ .__..___..___  .  ..__..  ..__..__ .___.__ ")
  );
  console.log(
    c.yellow("|  |[__)|  \\[__]  |  [__   |\\/|[__]|\\ |[__][ __[__ [__)")
  );
  console.log(
    c.yellow("|__||   |__/|  |  |  [___  |  ||  || \\||  |[_./[___|  \\")
  );
  console.log(
    c.yellow("_______________________________________________________")
  );
...
viewByDept = () => {
  console.log(
    c.cyan(".___.  ..__ .   .__..   ,.___.___  .__ .   ,  .__ .___.__ .___.")
  );
  console.log(
    c.cyan("[__ |\\/|[__)|   |  | \\./ [__ [__   [__) \\./   |  \\[__ [__)  |")
  );
  console.log(
    c.cyan("[___|  ||   |___|__|  |  [___[___  [__)  |    |__/[___|     |")
  );
  console.log(
    c.cyan("_____________________________________________________________")
  );
